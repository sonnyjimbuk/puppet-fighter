...
public class Zombie : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        GetAnimationStartingPosition();
        //DisableRagdoll();
    }

    //Sample the starting position of the stand up animations to get the target bone transforms
    //Call this method if any new animation is selected in the animator
    public void GetAnimationStartingPosition()
    {
    ...
    { 
        ...
        _timeToWakeUp = TimeToWakeUp;//5;//Random.Range(5, 10);
    } 
    ...
    {
        print("RagdollBehaviour() _timeToWakeUp: " + _timeToWakeUp);
    ...
    //Transition from ragdoll to animation by interpolating bone transforms
