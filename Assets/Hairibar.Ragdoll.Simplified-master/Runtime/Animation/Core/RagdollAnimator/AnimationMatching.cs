...
{
    public static class AnimationMatching
    {
        public static Vector3 GetAccelerationFromPositionSpring(Vector3 currentPos, Vector3 targetPos, Vector3 currentLinearVel, 
                                                                Vector3 targetLinearVel, float alpha, float dampingRatio, float mass, float dt)
        {
