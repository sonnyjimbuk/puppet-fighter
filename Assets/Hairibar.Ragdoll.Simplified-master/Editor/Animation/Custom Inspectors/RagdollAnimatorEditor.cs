...
namespace Hairibar.Ragdoll.Animation.Editor
{
    ...
    internal class RagdollAnimatorEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Multiple object editing isn't supported for debug features.", MessageType.Info);
            }
            else
            {
        ...
        void DrawBindingsField()
        {
            ...
            if (!bindings.objectReferenceValue)
            {
                ...
                EditorGUILayout.HelpBox("A RagdollDefinitionBindings must be assigned to the RagdollAnimator.", MessageType.Error);
            }
