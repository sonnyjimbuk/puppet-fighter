...
namespace Hairibar.Ragdoll.Editor
{
    ...
    internal class RagdollCollisionIgnoranceProfileEditor : RagdollProfileEditor
    {
        ...
        {
            EditorGUILayout.HelpBox("Bones that are connected to each other already ignore collisions between them.", MessageType.Info);
        }
        #endregion
        ...
        void ValidateNoSameBonePairs()
        {
            ...
            if (hasInvalidPairs)
            {
                EditorGUILayout.HelpBox("Pairs can't have the same bone on both sides.", MessageType.Warning);
                SetIsNotValid();
        ...
        void ValidateNoDuplicatePairs()
        {
            ...
            if (hasDuplicates)
            {
                EditorGUILayout.HelpBox("There are duplicate pairs.", MessageType.Warning);
                SetIsNotValid();
        ...
        void ValidateNoDuplicateDisabledBones()
        {
            ...
            if (hasDuplicates)
            {
                EditorGUILayout.HelpBox("There are duplicated bones.", MessageType.Warning);
                SetIsNotValid();
